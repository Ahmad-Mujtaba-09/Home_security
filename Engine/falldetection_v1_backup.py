...
class HomeSafetyInference:
    ...
    def _smooth_type(self, tid: int, raw_type: str, n: int = 10) -> str:
    ...
    def process_frame(
        ...
        hazards = self._detect_and_draw_hazards(frame)
...
if __name__ == "__main__":
    system = HomeSafetyInference(
        ...
        hazard_weights="weights/best_int8_openvino_model/",
        # yolo_weights="weights/yolo26s-pose_openvino_model/",
        # yolo_weights="weights/yolo8s-pose.pt",
        mode="hybrid",
        fall_threshold=0.65,
    )
    ...
    system.run(
        ...
        output_path="/home/ahmad/My_data/UNI/FYP/New/Engine/testing/test1_output.mp4",
    )
